...
class SendLocationReportEmail implements ShouldQueue
{
    ...
    private function getSystemPrompt(string $type) {
        ...
        $locationPrompt = "The incidents are centered around the user specified location: " . $this->location->address . ". ";
        $typePrompt = "The following data is specifically about $type. ";
        $generalInstructions = "Provide a clear and informative email report for the user specified location, highlighting the most significant events. The report is for residents of the area. Be factual and do not speculate. Do not generate any kind of disclaimer or note at the end of the report. 
        ...
        return $basePrompt . $locationPrompt . $typePrompt . $generalInstructions;
    }
}