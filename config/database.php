...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'san_francisco_db' => [
            'driver' => 'mysql',
            'host' => env('SAN_FRANCISCO_DB_HOST', 'mysql'),
            'port' => env('SAN_FRANCISCO_DB_PORT', '3306'),
            'database' => env('SAN_FRANCISCO_DB_DATABASE', 'san_francisco_db'),
            'username' => env('SAN_FRANCISCO_DB_USERNAME', 'sail'),
            'password' => env('SAN_FRANCISCO_DB_PASSWORD', 'password'),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
            'strict' => true,
        ...
        'san_francisco_crime_db' => [
            'driver' => 'mysql',
            'host' => env('SAN_FRANCISCO_CRIME_DB_HOST', 'mysql'),
            'port' => env('SAN_FRANCISCO_CRIME_DB_PORT', '3306'),
            'database' => env('SAN_FRANCISCO_CRIME_DB_DATABASE', 'san_francisco_crime_db'),
            'username' => env('SAN_FRANCISCO_CRIME_DB_USERNAME', 'sail'),
            'password' => env('SAN_FRANCISCO_CRIME_DB_PASSWORD', 'password'),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
            'strict' => true,
        ...
        'seattle_db' => [
            'driver' => 'mysql',
            'host' => env('SEATTLE_DB_HOST', 'mysql'),
            'port' => env('SEATTLE_DB_PORT', '3306'),
            'database' => env('SEATTLE_DB_DATABASE', 'seattle_db'),
            'username' => env('SEATTLE_DB_USERNAME', 'sail'),
            'password' => env('SEATTLE_DB_PASSWORD', 'password'),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
            'strict' => true,
        ...
        'seattle_crime_db' => [
            'driver' => 'mysql',
            'host' => env('SEATTLE_CRIME_DB_HOST', 'mysql'),
            'port' => env('SEATTLE_CRIME_DB_PORT', '3306'),
            'database' => env('SEATTLE_CRIME_DB_DATABASE', 'seattle_crime_db'),
            'username' => env('SEATTLE_CRIME_DB_USERNAME', 'sail'),
            'password' => env('SEATTLE_CRIME_DB_PASSWORD', 'password'),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
            'strict' => true,
